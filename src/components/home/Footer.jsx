        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold bg-gradient-to-r from-green-700 to-green-500 bg-clip-text text-transparent">
                  Kokan Community Forum
                </h3>
              </div>
            </div>
            <p className="text-gray-600 leading-relaxed mb-8 max-w-md">
              Strengthening bonds within the Kokan community through unity, education, and social service. Together, we build a better tomorrow.
            </p>
              ...
              <div className="flex gap-3">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    href={social.href}
                    title={social.name}
                    className={`w-10 h-10 bg-white border border-green-200 rounded-lg flex items-center justify-center text-gray-600 ${social.color} hover:text-white transition-all duration-300 hover:scale-110 shadow-sm hover:shadow-md`}
                  >
                    {social.icon}
                  </a>
                ))}
          ...
          <div>
            ...
            <div className="mt-8 space-y-4">
              ...
              <div className="flex items-start gap-3 text-gray-600">
                ...
                <span className="text-sm leading-5">39/4, Kadil Mulla House, Husain Patel Marg, mazgaon, Mumbai - 400010, India</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <span className="text-sm leading-5">+91 98201 04711</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <span className="text-sm leading-5">kokancommunityforumWKD@gmail.com</span>
              </div>
            </div>
          </div>
        </div>
