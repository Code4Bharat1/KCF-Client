      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-1">
            <button onClick={() => handleNavigation('/')} className="relative px-4 py-2 text-gray-700 hover:text-green-600 font-medium transition-all duration-200 group">
              Home
            ...
            >
              <button className="relative px-4 py-2 text-gray-700 hover:text-green-600 font-medium transition-all duration-200 group flex items-center gap-1">
                About Us
                <svg className={`w-4 h-4 transition-transform duration-200 ${aboutOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">Our community members</div>
                        </div>
                      </div>
                    ...
                    <div className="absolute left-full top-0 w-56 bg-white rounded-lg shadow-xl border border-green-100 overflow-hidden z-50">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className="font-medium">Supporting Members</span>
                        </div>
                      </button>
                    </div>
                  )}
                ...
                <div className="pl-8 pr-4 py-2 space-y-2">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <svg className={`w-3 h-3 transition-transform duration-200 ${mobileMembersOpen ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                      </svg>
                    </button>
