...
function AchieversAward() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Append image files
      if (formData.aadhaarImages.length > 0) {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Nominate outstanding community members who have made significant
          ...
          <div className="mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Example: National Science Award 2023, Best Employee Award 2022,
                etc.
              </p>
            </div>
          </div>
