...
function AdminDashboard() {
 ...
 useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-green-50 pt-32 pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-base sm:text-lg text-gray-600">Manage all applications and scholarships</p>
        </div>

        {/* Tabs */}
        <div className="bg-white rounded-2xl shadow-2xl mb-8 overflow-hidden">
          <div className="border-b-2 border-gray-100">
            <nav className="flex overflow-x-auto bg-gradient-to-r from-gray-50 to-white" aria-label="Tabs">
              <button
            ...
            {activeTab === 'achievers' && (
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">Achievers Award Applications</h2>
                </div>
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 pb-6 border-b-2 border-green-100">
                        <div className="flex items-center gap-4">
                          <div className="w-16 h-16 bg-gradient-to-br from-green-500 via-emerald-500 to-teal-500 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                            {applicant.firstName?.[0] || 'A'}{applicant.surname?.[0] || 'A'}
                          </div>
                          <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        <div className="bg-white p-4 rounded-xl border border-green-100 hover:border-green-300 transition-colors">
                          ...
                          <p className="text-sm text-gray-800 font-medium break-words">{applicant.email}</p>
                        </div>
                        <div className="bg-white p-4 rounded-xl border border-green-100 hover:border-green-300 transition-colors">
                          <p className="text-xs font-semibold text-green-600 mb-1 uppercase tracking-wide flex items-center gap-1">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <p className="text-sm text-gray-800 font-medium">{applicant.contactNumber}</p>
                        </div>
                      </div>
            ...
            {activeTab === 'scholarship' && (
              <div className="space-y-6">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">AI Scholarship Applications</h2>
                </div>
                    ...
                    >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 pb-6 border-b-2 border-blue-100">
                        <div className="flex items-center gap-4">
                          <div className="w-16 h-16 bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-lg">
                            {applicant.fullName?.split(' ').map(n => n[0]).join('') || 'NA'}
                          </div>
                          <div>
                            <h3 className="text-xl sm:text-2xl font-bold text-gray-800 mb-1">{applicant.fullName}</h3>
                            <p className="text-sm text-gray-500 flex items-center gap-2">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                              </svg>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                        ...
                        <div className="bg-white p-4 rounded-xl border border-blue-100 hover:border-blue-300 transition-colors">
                          ...
                          <p className="text-sm text-gray-800 font-medium">{applicant.mobile}</p>
                        </div>
                      </div>

                      {/* Action Button */}
                      <button 
                        onClick={() => handleViewDetails(applicant, 'scholarship')}
                        className="w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-md hover:shadow-lg active:scale-95 flex items-center justify-center gap-2"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
          ...
          <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:p-0">
            ...
            <div className="relative inline-block w-full max-w-4xl p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-2xl rounded-2xl border-2 border-gray-200">
              ...
              <div className="mb-6 pb-4 border-b border-gray-200">
                ...
                <span className="text-sm text-gray-500">Applied on {formatDate(selectedApplicant.createdAt)}</span>
              </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 p-4 rounded-lg">
                        ...
                        <div>
                          <p className="text-xs font-semibold text-gray-500 mb-1">Contact Number</p>
                          <p className="text-sm text-gray-800">{selectedApplicant.contactNumber}</p>
                        </div>
                        <div>
                          <p className="text-xs font-semibold text-gray-500 mb-1">Current Address</p>
                          <p className="text-sm text-gray-800">{selectedApplicant.currentAddress}</p>
                        </div>
                        <div>
                          <p className="text-xs font-semibold text-gray-500 mb-1">Native Address</p>
                          <p className="text-sm text-gray-800">{selectedApplicant.nativeAddress}</p>
                        </div>
                        <div>
                          <p className="text-xs font-semibold text-gray-500 mb-1">Aadhaar Number</p>
                          <p className="text-sm text-gray-800">{selectedApplicant.aadhaar}</p>
                        </div>
                      </div>
                    </div>

                    {selectedApplicant.aadhaarImages && selectedApplicant.aadhaarImages.length > 0 && (
                      <div>
                        <h3 className="text-lg font-bold text-gray-800 mb-3 flex items-center gap-2">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          {selectedApplicant.aadhaarImages.map((img, index) => (
                            <div key={index} className="relative group">
                              ...
                              <button
                                onClick={() => handleViewAadhaar(getImageUrl(img))}
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="bg-green-50 p-4 rounded-lg">
                          <p className="text-xs font-semibold text-gray-600 mb-2">SSC</p>
                          <p className="text-lg font-bold text-gray-800">{selectedApplicant.education?.ssc?.score}</p>
                          <p className="text-sm text-gray-600">Year: {selectedApplicant.education?.ssc?.year}</p>
                        </div>
                        <div className="bg-blue-50 p-4 rounded-lg">
                          <p className="text-xs font-semibold text-gray-600 mb-2">HSC</p>
                          <p className="text-lg font-bold text-gray-800">{selectedApplicant.education?.hsc?.score}</p>
                          <p className="text-sm text-gray-600">Year: {selectedApplicant.education?.hsc?.year}</p>
                        </div>
                        <div className="bg-purple-50 p-4 rounded-lg">
                          <p className="text-xs font-semibold text-gray-600 mb-2">Graduation</p>
                          <p className="text-lg font-bold text-gray-800">{selectedApplicant.education?.graduation?.degree || 'Not Provided'}</p>
                          {selectedApplicant.education?.graduation?.year && (
                            <p className="text-sm text-gray-600">Year: {selectedApplicant.education.graduation.year}</p>
                          )}
                        </div>
                        <div className="bg-pink-50 p-4 rounded-lg">
                          <p className="text-xs font-semibold text-gray-600 mb-2">Post Graduation</p>
                          <p className="text-lg font-bold text-gray-800">{selectedApplicant.education?.postGraduation?.degree || 'Not Provided'}</p>
                          {selectedApplicant.education?.postGraduation?.year && (
                            <p className="text-sm text-gray-600">Year: {selectedApplicant.education.postGraduation.year}</p>
                          )}
                        </div>
                      </div>
                    </div>
                    ...
                    {selectedApplicant.awardsReceived && (
                      <div>
                        ...
                        <div className="bg-yellow-50 p-4 rounded-lg">
                          <p className="text-sm text-gray-800">{selectedApplicant.awardsReceived}</p>
                        </div>
                      </div>
                    )}
